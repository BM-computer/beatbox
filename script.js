...
let beats = {
  65: {
    beat: new Beat("./assets/Afro-Warriors-AfroZone-Obsession-Original_51qCR5RnHzo.mp3"),
...
function triggerBeatOnclik(){
  beats[id].beat.play()
  beats[id].button.select()
  console.log();
}
...
// document.getElementById(id).addEventListener('keyup', triggerBeatOnclik);
// }